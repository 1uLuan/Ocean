...
const _tmpl$ = template(`<svg><ellipse cx="128" cy="128" rx="32" ry="48" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></ellipse></svg>`, 4, true),
      ...
      _tmpl$4 = template(`<svg><ellipse cx="128" cy="128" rx="32" ry="48" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></ellipse></svg>`, 4, true),
      _tmpl$5 = template(`<svg><circle cx="128" cy="128" r="96" fill="none" stroke-miterlimit="10" stroke-width="16"></circle></svg>`, 4, true),
      _tmpl$6 = template(`<svg><g><ellipse cx="128" cy="128" rx="24" ry="40"></ellipse><path d="M128,24A104,104,0,1,0,232,128,104.12041,104.12041,0,0,0,128,24Zm0,160c-27.63281,0-40-28.125-40-56s12.36719-56,40-56,40,28.125,40,56S155.63281,184,128,184Z"></path></g></svg>`, 8, true),
      _tmpl$7 = template(`<svg><ellipse cx="128" cy="128" rx="32" ry="48" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></ellipse></svg>`, 4, true),
      ...
      _tmpl$9 = template(`<svg><ellipse cx="128" cy="128" rx="32" ry="48" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"></ellipse></svg>`, 4, true),
...
var NumberCircleZero = function NumberCircleZero(props, ref) {
