...
const _tmpl$ = template(`<svg><polyline points="80 40 24 128 80 216" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></polyline></svg>`, 4, true),
      _tmpl$2 = template(`<svg><polyline points="176 40 232 128 176 216" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></polyline></svg>`, 4, true),
      _tmpl$3 = template(`<svg><polyline points="80 40 24 128 80 216" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`, 4, true),
      _tmpl$4 = template(`<svg><polyline points="176 40 232 128 176 216" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`, 4, true),
      _tmpl$5 = template(`<svg><path d="M86.749,44.29492,33.48242,128,86.749,211.70508a7.99973,7.99973,0,1,1-13.498,8.58984l-56-88a7.99826,7.99826,0,0,1,0-8.58984l56-88a7.99973,7.99973,0,0,1,13.498,8.58984Zm152,79.41016-56-88a7.99973,7.99973,0,0,0-13.498,8.58984L222.51758,128,169.251,211.70508a7.99973,7.99973,0,1,0,13.498,8.58984l56-88A7.99826,7.99826,0,0,0,238.749,123.70508Z"></path></svg>`, 4, true),
      _tmpl$6 = template(`<svg><polyline points="80 40 24 128 80 216" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></polyline></svg>`, 4, true),
      _tmpl$7 = template(`<svg><polyline points="176 40 232 128 176 216" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></polyline></svg>`, 4, true),
      _tmpl$8 = template(`<svg><polyline points="80 40 24 128 80 216" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"></polyline></svg>`, 4, true),
      _tmpl$9 = template(`<svg><polyline points="176 40 232 128 176 216" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"></polyline></svg>`, 4, true),
...
var BracketsAngle = function BracketsAngle(props, ref) {
...
//# sourceMappingURL=BracketsAngle.esm.js.map
