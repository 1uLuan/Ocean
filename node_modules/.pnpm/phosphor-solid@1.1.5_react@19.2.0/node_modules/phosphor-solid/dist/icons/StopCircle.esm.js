...
const _tmpl$ = template(`<svg><circle cx="128" cy="128" r="96" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></circle></svg>`, 4, true),
      _tmpl$2 = template(`<svg><rect x="108" y="108" width="40" height="40" stroke-width="24" stroke-linecap="round" stroke-linejoin="round"></rect></svg>`, 4, true),
      _tmpl$3 = template(`<svg><path d="M128,32a96,96,0,1,0,96,96A95.99991,95.99991,0,0,0,128,32Zm24,120H104V104h48Z" opacity="0.2"></path></svg>`, 4, true),
      _tmpl$4 = template(`<svg><circle cx="128" cy="128" r="96" fill="none" stroke-miterlimit="10" stroke-width="16"></circle></svg>`, 4, true),
      _tmpl$5 = template(`<svg><rect x="104" y="104" width="48" height="48" stroke-width="16" stroke-linecap="round" stroke-linejoin="round" fill="none"></rect></svg>`, 4, true),
      _tmpl$6 = template(`<svg><path d="M128,24A104,104,0,1,0,232,128,104.11791,104.11791,0,0,0,128,24Zm32,128a8.00008,8.00008,0,0,1-8,8H104a8.00008,8.00008,0,0,1-8-8V104a8.00008,8.00008,0,0,1,8-8h48a8.00008,8.00008,0,0,1,8,8Z"></path></svg>`, 4, true),
      ...
      _tmpl$8 = template(`<svg><rect x="104" y="104" width="48" height="48" stroke-width="12" stroke-linecap="round" stroke-linejoin="round" fill="none"></rect></svg>`, 4, true),
      ...
      _tmpl$10 = template(`<svg><rect x="104" y="104" width="48" height="48" stroke-width="8" stroke-linecap="round" stroke-linejoin="round" fill="none"></rect></svg>`, 4, true),
...
var StopCircle = function StopCircle(props, ref) {
