...
const _tmpl$ = template(`<svg><circle cx="128" cy="128" r="96" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></circle></svg>`, 4, true),
      _tmpl$2 = template(`<svg><polyline points="104 84 152 84 120 180" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></polyline></svg>`, 4, true),
      ...
      _tmpl$5 = template(`<svg><polyline points="104 84 152 84 120 180" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`, 4, true),
      _tmpl$6 = template(`<svg><path d="M128,24A104,104,0,1,0,232,128,104.11791,104.11791,0,0,0,128,24Zm31.58984,62.53027-32,96a8.0005,8.0005,0,1,1-15.17968-5.06054L140.90039,92H104a8,8,0,0,1,0-16h48a8.00022,8.00022,0,0,1,7.58984,10.53027Z"></path></svg>`, 4, true),
      ...
      _tmpl$8 = template(`<svg><polyline points="104 84 152 84 120 180" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></polyline></svg>`, 4, true),
      ...
      _tmpl$10 = template(`<svg><polyline points="104 84 152 84 120 180" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"></polyline></svg>`, 4, true),
...
var NumberCircleSeven = function NumberCircleSeven(props, ref) {
