...
const _tmpl$ = template(`<svg><circle cx="128" cy="128" r="96" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></circle></svg>`, 4, true),
      _tmpl$2 = template(`<svg><polyline points="164 116 128 156 92 116" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></polyline></svg>`, 4, true),
      ...
      _tmpl$5 = template(`<svg><polyline points="164 116 128 156 92 116" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`, 4, true),
      _tmpl$6 = template(`<svg><path d="M128,24A104,104,0,1,0,232,128,104.12041,104.12041,0,0,0,128,24Zm41.94531,97.35156-36,40a7.99734,7.99734,0,0,1-11.89062,0l-36-40a7.99912,7.99912,0,1,1,11.89062-10.70312L128,144.03906l30.05469-33.39062a7.99912,7.99912,0,1,1,11.89062,10.70312Z"></path></svg>`, 4, true),
      _tmpl$7 = template(`<svg><circle cx="128" cy="128" r="96" fill="none" stroke-miterlimit="10" stroke-width="12"></circle></svg>`, 4, true),
      _tmpl$8 = template(`<svg><polyline points="164 116 128 156 92 116" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></polyline></svg>`, 4, true),
      _tmpl$9 = template(`<svg><circle cx="128" cy="128" r="96" fill="none" stroke-miterlimit="10" stroke-width="8"></circle></svg>`, 4, true),
      _tmpl$10 = template(`<svg><polyline points="164 116 128 156 92 116" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"></polyline></svg>`, 4, true),
...
var CaretCircleDown = function CaretCircleDown(props, ref) {
