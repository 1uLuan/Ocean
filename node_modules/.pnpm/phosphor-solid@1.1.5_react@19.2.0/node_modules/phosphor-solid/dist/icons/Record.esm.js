...
const _tmpl$ = template(`<svg><circle cx="128" cy="128" r="96" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></circle></svg>`, 4, true),
      _tmpl$2 = template(`<svg><circle cx="128" cy="128" r="56" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></circle></svg>`, 4, true),
      _tmpl$3 = template(`<svg><circle cx="128" cy="128" r="64" opacity="0.2"></circle></svg>`, 4, true),
      _tmpl$4 = template(`<svg><circle cx="128" cy="128" r="96" fill="none" stroke-miterlimit="10" stroke-width="16"></circle></svg>`, 4, true),
      _tmpl$5 = template(`<svg><circle cx="128" cy="128" r="64" fill="none" stroke-miterlimit="10" stroke-width="16"></circle></svg>`, 4, true),
      _tmpl$6 = template(`<svg><g><path d="M128,24A104,104,0,1,0,232,128,104.11791,104.11791,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.09957,88.09957,0,0,1,128,216Z"></path><circle cx="128" cy="128" r="72"></circle></g></svg>`, 8, true),
      ...
      _tmpl$8 = template(`<svg><circle cx="128" cy="128" r="64" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></circle></svg>`, 4, true),
      ...
      _tmpl$10 = template(`<svg><circle cx="128" cy="128" r="64" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"></circle></svg>`, 4, true),
...
var Record = function Record(props, ref) {
