...
const _tmpl$ = template(`<svg><polyline points="176 152 224 104 176 56" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></polyline></svg>`, 4, true),
      _tmpl$2 = template(`<svg><polyline points="120 152 168 104 120 56" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></polyline></svg>`, 4, true),
      _tmpl$3 = template(`<svg><path d="M32,200a96,96,0,0,1,96-96h40" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></path></svg>`, 4, true),
      _tmpl$4 = template(`<svg><polyline points="176 152 224 104 176 56" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`, 4, true),
      _tmpl$5 = template(`<svg><polyline points="128 152 176 104 128 56" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`, 4, true),
      _tmpl$6 = template(`<svg><path d="M32,200a96,96,0,0,1,96-96h48" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path></svg>`, 4, true),
      _tmpl$7 = template(`<svg><path d="M229.65723,109.65723l-48,48a8.00053,8.00053,0,0,1-11.31446-11.31446L212.68652,104,170.34277,61.65723a8.00053,8.00053,0,0,1,11.31446-11.31446l48,48A8.00122,8.00122,0,0,1,229.65723,109.65723Zm-48-11.31446-48-48A8.00066,8.00066,0,0,0,120,56V96.30469A104.13965,104.13965,0,0,0,24,200a8,8,0,0,0,16,0,88.11673,88.11673,0,0,1,80-87.63232V152a8.00053,8.00053,0,0,0,13.65723,5.65723l48-48A8.00122,8.00122,0,0,0,181.65723,98.34277Z"></path></svg>`, 4, true),
      _tmpl$8 = template(`<svg><polyline points="176 152 224 104 176 56" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></polyline></svg>`, 4, true),
      _tmpl$9 = template(`<svg><polyline points="128 152 176 104 128 56" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></polyline></svg>`, 4, true),
      _tmpl$10 = template(`<svg><path d="M32,200a96,96,0,0,1,96-96h48" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></path></svg>`, 4, true),
      _tmpl$11 = template(`<svg><polyline points="176 152 224 104 176 56" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"></polyline></svg>`, 4, true),
      _tmpl$12 = template(`<svg><polyline points="128 152 176 104 128 56" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"></polyline></svg>`, 4, true),
      _tmpl$13 = template(`<svg><path d="M32,200a96,96,0,0,1,96-96h48" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="8"></path></svg>`, 4, true),
...
var ArrowBendDoubleUpRight = function ArrowBendDoubleUpRight(props, ref) {
