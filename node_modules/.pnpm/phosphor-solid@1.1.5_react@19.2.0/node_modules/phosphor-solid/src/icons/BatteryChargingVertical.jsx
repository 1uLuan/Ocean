...
const renderPathFor = (weight, color) => {
  ...
  <polyline points="128 172 144 132 112 132 128 92" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
        </>);
        case "fill":
            return (<>
          <g>
  ...
  <polyline points="128 172 144 132 112 132 128 92" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
        </>);
        case "thin":
            return (<>
  ...
  <polyline points="128 172 144 132 112 132 128 92" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
        </>);
        case "regular":
            return (<>
          <line x1="96" y1="8" x2="160" y2="8" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
...
const BatteryChargingVertical = (props, ref) => {
