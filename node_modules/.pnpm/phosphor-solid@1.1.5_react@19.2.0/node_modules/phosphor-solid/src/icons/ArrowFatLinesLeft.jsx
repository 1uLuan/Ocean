...
const renderPathFor = (weight, color) => {
    switch (weight) {
        case "bold":
            return (<>
          <polygon points="120 32 24 128 120 224 120 176 140 176 140 80 120 80 120 32" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <line x1="184" y1="176" x2="184" y2="80" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
        ...
        case "light":
            return (<>
          <polygon points="120 32 24 128 120 224 120 176 152 176 152 80 120 80 120 32" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <line x1="184" y1="176" x2="184" y2="80" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
        ...
        case "thin":
            return (<>
          <polygon points="120 32 24 128 120 224 120 176 152 176 152 80 120 80 120 32" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
...
const ArrowFatLinesLeft = (props, ref) => {
