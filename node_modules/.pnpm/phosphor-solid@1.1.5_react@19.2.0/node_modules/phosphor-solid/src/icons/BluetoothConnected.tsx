...
const renderPathFor = (weight: string, color: string) => {
  switch (weight) {
    case "bold":
      return (
        <>
          <polygon points="120 32 184 80 120 128 120 32" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <circle cx="196" cy="128" r="12"/>
    ...
    case "light":
      return (
        <>
          <polygon points="120 32 184 80 120 128 120 32" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <circle cx="196" cy="128" r="10"/>
    ...
    case "thin":
      return (
        <>
          <polygon points="120 32 184 80 120 128 120 32" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
...
const BluetoothConnected = (props: any, ref: any)  => {
