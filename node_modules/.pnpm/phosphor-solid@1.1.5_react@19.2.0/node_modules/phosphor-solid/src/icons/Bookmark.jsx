...
const renderPathFor = (weight, color) => {
  ...
  <polyline points="191.982 176 127.975 136 63.982 176" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
        </>);
        case "duotone":
            return (<>
  ...
  <polyline points="191.971 176 127.963 136 63.971 176" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
        </>);
        case "fill":
            return (<>
  ...
  <polyline points="191.988 176 127.981 136 63.988 176" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
        </>);
        case "thin":
            return (<>
  ...
  <polyline points="191.994 176 127.987 136 63.994 176" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
        </>);
        case "regular":
            return (<>
  ...
  <polyline points="192 176 127.993 136 64 176" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
        </>);
        default:
