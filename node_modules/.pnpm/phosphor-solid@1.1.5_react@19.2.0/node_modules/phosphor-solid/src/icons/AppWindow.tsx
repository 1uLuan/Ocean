...
const renderPathFor = (weight: string, color: string) => {
  switch (weight) {
    case "bold":
      return (
        <>
          <rect x="32" y="48.00586" width="192" height="160" rx="8" stroke-width="24" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  ...
  <rect x="32" y="48.00586" width="192" height="160" rx="8" stroke-width="16" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  ...
  <circle cx="108" cy="84.00586" r="12"/>
    ...
    case "light":
      return (
        <>
          <rect x="32" y="48.00586" width="192" height="160" rx="8" stroke-width="12" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  ...
  <circle cx="108" cy="84.00586" r="10"/>
    ...
    case "thin":
      return (
        <>
          <rect x="32" y="48.00586" width="192" height="160" rx="8" stroke-width="8" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
...
const AppWindow = (props: any, ref: any)  => {
