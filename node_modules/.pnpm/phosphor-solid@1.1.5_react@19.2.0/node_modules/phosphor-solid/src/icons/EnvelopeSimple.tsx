...
const renderPathFor = (weight: string, color: string) => {
  ...
  <polyline points="224 56 128 144 32 56" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
        </>
      )
    case "duotone":
      return (
  ...
  <polyline points="224 56 128 144 32 56" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
        </>
      )
    case "thin":
      return (
  ...
  <polyline points="224 56 128 144 32 56" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
        </>
      )
    case "regular":
      return (
...
const EnvelopeSimple = (props: any, ref: any)  => {
