...
const renderPathFor = (weight, color) => {
  ...
  <path d="M128.001,136.0045a28,28,0,1,0-28-28" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
        </>);
        case "duotone":
            return (<>
  ...
  <path d="M128.00194,144.0045v-8a28,28,0,1,0-28-28" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
        </>);
        case "fill":
            return (<>
  ...
  <path d="M128.00048,144.0045v-8a28,28,0,1,0-28-28" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
        </>);
        case "thin":
            return (<>
  ...
  <path d="M128,144.0045v-8a28,28,0,1,0-28-28" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
        </>);
        case "regular":
            return (<>
