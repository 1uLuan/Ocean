...
const renderPathFor = (weight: string, color: string) => {
  ...
  <rect x="80" y="80" width="96" height="96" stroke-width="24" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
        </>
      )
    case "duotone":
      return (
  ...
  <rect x="80" y="80" width="96" height="96" stroke-width="16" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
        </>
      )
    case "fill":
      return (
  ...
  <rect x="80" y="80" width="96" height="96" stroke-width="12" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
        </>
      )
    case "thin":
      return (
  ...
  <rect x="80" y="80" width="96" height="96" stroke-width="8" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
        </>
      )
    case "regular":
      return (
...
const SelectionAll = (props: any, ref: any)  => {
