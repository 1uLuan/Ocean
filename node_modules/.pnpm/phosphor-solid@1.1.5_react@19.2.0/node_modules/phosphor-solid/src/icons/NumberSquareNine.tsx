...
const renderPathFor = (weight: string, color: string) => {
  switch (weight) {
    case "bold":
      return (
        <>
          <line x1="152.24871" y1="126.00466" x2="120" y2="180.00001" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <circle cx="128" cy="112" r="28" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
    ...
    case "light":
      return (
        <>
          <line x1="152.24871" y1="126.00466" x2="120" y2="180.00001" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <circle cx="128" cy="112" r="28" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
    ...
    case "thin":
      return (
        <>
          <line x1="152.24871" y1="126.00466" x2="120" y2="180.00001" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
...
const NumberSquareNine = (props: any, ref: any)  => {
