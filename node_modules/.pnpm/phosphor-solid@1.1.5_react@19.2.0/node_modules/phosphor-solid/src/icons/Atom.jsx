...
const renderPathFor = (weight, color) => {
    switch (weight) {
        case "bold":
            return (<>
          <ellipse cx="128" cy="128" rx="44" ry="116" transform="translate(-53.01934 128) rotate(-45)" stroke-width="24" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  <ellipse cx="128" cy="128" rx="116" ry="44" transform="translate(-53.01934 128) rotate(-45)" stroke-width="24" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  ...
  <circle cx="128" cy="128" r="12"/>
        ...
        case "light":
            return (<>
          <ellipse cx="128" cy="128" rx="44" ry="116" transform="translate(-53.01934 128) rotate(-45)" stroke-width="12" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  <ellipse cx="128" cy="128" rx="116" ry="44" transform="translate(-53.01934 128) rotate(-45)" stroke-width="12" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  <circle cx="128" cy="128" r="10"/>
        </>);
        case "thin":
            return (<>
          <ellipse cx="128" cy="128" rx="44" ry="116" transform="translate(-53.01934 128) rotate(-45)" stroke-width="8" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  <ellipse cx="128" cy="128" rx="116" ry="44" transform="translate(-53.01934 128) rotate(-45)" stroke-width="8" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
