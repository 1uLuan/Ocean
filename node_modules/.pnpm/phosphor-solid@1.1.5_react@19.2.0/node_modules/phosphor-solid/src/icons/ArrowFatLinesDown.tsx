...
const renderPathFor = (weight: string, color: string) => {
  switch (weight) {
    case "bold":
      return (
        <>
          <polygon points="32 136 128 232 224 136 176 136 176 116 80 116 80 136 32 136" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <line x1="176" y1="80" x2="80" y2="80" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
    ...
    case "duotone":
      return (
        <>
          <polygon points="32 136 128 232 224 136 176 136 176 104 80 104 80 136 32 136" opacity="0.2"/>
  ...
  <line x1="176" y1="72" x2="80" y2="72" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
    ...
    case "light":
      return (
        <>
          <polygon points="32 136 128 232 224 136 176 136 176 104 80 104 80 136 32 136" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <line x1="176" y1="72" x2="80" y2="72" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
    ...
    case "thin":
      return (
        <>
          <polygon points="32 136 128 232 224 136 176 136 176 104 80 104 80 136 32 136" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
...
const ArrowFatLinesDown = (props: any, ref: any)  => {
